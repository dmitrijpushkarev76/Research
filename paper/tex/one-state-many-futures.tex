...
\author{%
  ...
  \normalsize Al-Farabi 101, Almaty, Kazakhstan \\
...
below. Two independent mechanisms produce the two counts. Failure of local
Lipschitz uniqueness at the
...
form for $T_{*}$. We claim no uniqueness or optimality for the choice.
